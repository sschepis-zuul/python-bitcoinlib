# Copyright (C) 2016 The python-gozerlib developers
#
...
class Test_Segwit(unittest.TestCase):
    ...
    def test_p2wpkh_signaturehash(self):
        ...
        address = CGozerAddress.from_scriptPubKey(scriptpubkey)
    ...
    def test_p2sh_p2wpkh_signaturehash(self):
        ...
        address = CGozerAddress.from_scriptPubKey(redeemscript)
        self.assertEqual(SignatureHash(address.to_scriptPubKey(), CTransaction.deserialize(unsigned_tx), 
    ...
    def test_checkblock(self):
        # (No witness) coinbase generated by Gozer Core
        ...
        commitment_script = gozer.core.WITNESS_COINBASE_SCRIPTPUBKEY_MAGIC + commitment
