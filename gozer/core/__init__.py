# Copyright (C) 2012-2015 The python-gozerlib developers
#
...
WITNESS_COINBASE_SCRIPTPUBKEY_MAGIC = _bytes([OP_RETURN, 0xcc, 0xb6, 0x4a, 0xff, 0xde])
...
class CTransaction(ImmutableSerializable):
    ...
    def stream_deserialize(cls, f):
        """Deserialize a transaction.  This implementation corresponds to
            Gozer's SerializeTransaction() and consensus behavior.  Note that
            Gozer's DecodeHexTx() also has the option to attempt deserializing
...
class CBlock(CBlockHeader):
    ...
    def build_merkle_tree_from_txids(txids):
        ...
        duplicate txids, resulting in a vulnerability. (CVE-2012-2459) Gozer
...
class CoreChainParams(object):
    """Define consensus-critical parameters of a given instance of the Gozer system"""
    MAX_MONEY = None
    GENESIS_BLOCK = None
...
class CoreMainParams(CoreChainParams):
    ...
    NAME = 'mainnet'
    GENESIS_BLOCK = CBlock.deserialize(x(''))
    SUBSIDY_HALVING_INTERVAL = 210240
    PROOF_OF_WORK_LIMIT = 2**256-1 >> 20

class CoreTestNetParams(CoreMainParams):
    NAME = 'testnet'
    GENESIS_BLOCK = CBlock.deserialize(x(''))
    SUBSIDY_HALVING_INTERVAL = 210240
    PROOF_OF_WORK_LIMIT = 2**256-1 >> 20

class CoreDevNetParams(CoreMainParams):
    NAME = 'devnet'
    GENESIS_BLOCK = CBlock.deserialize(x(''))
    SUBSIDY_HALVING_INTERVAL = 210240
...
class CoreRegTestParams(CoreTestNetParams):
    NAME = 'regtest'
    GENESIS_BLOCK = CBlock.deserialize(x(''))
...
def _SelectCoreParams(name):
    ...
    Don't use this directly, use gozer.SelectParams() instead so both
